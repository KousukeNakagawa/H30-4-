...
public class TutorialBreakEffectManager : MonoBehaviour {
    ...
    private void Change()
    {
        switch (effectType)
        {
            ...
            case BreakEffectType.Light:
                ...
                TutorialEnemyScripts.breakRobotoManager.BreakRobotAction();
    ...
    IEnumerator RandomExplosion()
    {
        ...
        while (loopTime > Time.time)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                explosions.Add(ex);
                TutorialEnemyScripts.bigEnemyAudioManager.Play(BigEnemyAudioType.Explosion, ex.transform);
            }
