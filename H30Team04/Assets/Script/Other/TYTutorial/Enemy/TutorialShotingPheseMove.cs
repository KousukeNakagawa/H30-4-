...
public class TutorialShotingPheseMove : MonoBehaviour {
    ...
    [Header("Y座標は関係ありません")]
    [SerializeField, Tooltip("射撃フェーズでの目標座標")]
